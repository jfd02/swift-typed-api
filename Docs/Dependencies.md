...
By default, CreateAPI uses [TypedAPI](https://github.com/jfd02/swift-typed-api) for the generated request/runtime layer. If you are generating a package, this dependency is set up for you automatically, but if you are generating for an existing module, you will need to manage dependencies yourself.
...
---|---|---
[TypedAPI](https://github.com/jfd02/swift-typed-api)|0.3.0|Generating Paths*
