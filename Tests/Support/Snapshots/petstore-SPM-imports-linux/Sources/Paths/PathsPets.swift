...
extension Paths {
    ...
    public struct Pets {
        ...
        /// List all pets
        public func get(limit: Int32? = nil) -> Request<[petstore_SPM_imports_linux.Pet], GetError> {
        ...
        public enum GetError: RequestError {
            ...
            public static func decode(statusCode: Int, data: Data, decoder: JSONDecoder) throws -> Self {
                switch statusCode {
                default: return .`default`(statusCode: statusCode, try decoder.decode(petstore_SPM_imports_linux.Error.self, from: data))
                }
            }
