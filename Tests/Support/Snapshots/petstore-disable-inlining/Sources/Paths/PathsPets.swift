...
extension Paths {
    ...
    public struct Pets {
        ...
        /// List all pets
        public func get(limit: Int32? = nil) -> Request<petstore_disable_inlining.Pets, GetError> {
            Request(path: path, method: "GET", query: makeGetQuery(limit), id: "listPets")
        }

        public enum GetError: RequestError {
            case `default`(statusCode: Int, petstore_disable_inlining.Error)
            case unhandled(any Swift.Error)

            public static func decode(statusCode: Int, data: Data, decoder: JSONDecoder) throws -> Self {
                switch statusCode {
                default: return .`default`(statusCode: statusCode, try decoder.decode(petstore_disable_inlining.Error.self, from: data))
                }
            }
        }
