...
extension Paths.Repos.WithOwner.WithRepo.Branches.WithBranch.Protection.Restrictions {
    ...
    public struct Apps {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<[OctoKit.Integration], PostError> {
        ...
        public func put(_ body: PutRequest? = nil) -> Request<[OctoKit.Integration], PutError> {
        ...
        public func delete(_ body: DeleteRequest? = nil) -> Request<[OctoKit.Integration], DeleteError> {
