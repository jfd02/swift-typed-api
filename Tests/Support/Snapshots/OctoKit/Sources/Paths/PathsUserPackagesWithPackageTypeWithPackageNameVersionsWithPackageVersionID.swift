...
extension Paths.User.Packages.WithPackageType.WithPackageName.Versions {
    ...
    public struct WithPackageVersionID {
        ...
        public var get: Request<OctoKit.PackageVersion, DefaultRequestError> {
            Request(path: path, method: "GET", id: "packages/get-package-version-for-authenticated-user")
        }
        ...
        public var delete: Request<Void, DeleteError> {
            Request(path: path, method: "DELETE", id: "packages/delete-package-version-for-authenticated-user")
        }
