...
extension Paths.Repos.WithOwner.WithRepo {
    ...
    public struct Pulls {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<[OctoKit.PullRequestSimple], GetError> {
        ...
        public func post(_ body: PostRequest) -> Request<OctoKit.PullRequest, PostError> {
