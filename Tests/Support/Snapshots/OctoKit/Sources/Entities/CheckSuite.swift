...
public struct CheckSuite: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.isRerequestable = values.contains("rerequestable") ? Optional.some(try values.decode(Bool.self, forKey: "rerequestable")) : nil
        self.isRunsRerequestable = values.contains("runs_rerequestable") ? Optional.some(try values.decode(Bool.self, forKey: "runs_rerequestable")) : nil
    }
