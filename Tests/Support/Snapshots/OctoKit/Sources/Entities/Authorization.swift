...
public struct Authorization: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.tokenLastEight = try values.decode(String?.self, forKey: "token_last_eight")
        self.hashedToken = try values.decode(String?.self, forKey: "hashed_token")
        self.app = try values.decode(App.self, forKey: "app")
        self.note = try values.decode(String?.self, forKey: "note")
        self.noteURL = try values.decode(URL?.self, forKey: "note_url")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encode(tokenLastEight, forKey: "token_last_eight")
        try values.encode(hashedToken, forKey: "hashed_token")
        try values.encode(app, forKey: "app")
        try values.encode(note, forKey: "note")
        try values.encode(noteURL, forKey: "note_url")
