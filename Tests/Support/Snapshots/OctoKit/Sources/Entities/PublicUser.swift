...
public struct PublicUser: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.privateGists = values.contains("private_gists") ? Optional.some(try values.decode(Int.self, forKey: "private_gists")) : nil
        ...
        self.diskUsage = values.contains("disk_usage") ? Optional.some(try values.decode(Int.self, forKey: "disk_usage")) : nil
        self.collaborators = values.contains("collaborators") ? Optional.some(try values.decode(Int.self, forKey: "collaborators")) : nil
    }
