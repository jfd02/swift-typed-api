...
public struct Release: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.mentionsCount = values.contains("mentions_count") ? Optional.some(try values.decode(Int.self, forKey: "mentions_count")) : nil
        self.discussionURL = values.contains("discussion_url") ? Optional.some(try values.decode(URL.self, forKey: "discussion_url")) : nil
