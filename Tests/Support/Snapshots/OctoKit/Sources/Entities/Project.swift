...
public struct Project: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.organizationPermission = values.contains("organization_permission") ? Optional.some(try values.decode(OrganizationPermission.self, forKey: "organization_permission")) : nil
