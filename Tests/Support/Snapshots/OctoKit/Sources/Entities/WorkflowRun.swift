...
public struct WorkflowRun: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.checkSuiteID = values.contains("check_suite_id") ? Optional.some(try values.decode(Int.self, forKey: "check_suite_id")) : nil
        self.checkSuiteNodeID = values.contains("check_suite_node_id") ? Optional.some(try values.decode(String.self, forKey: "check_suite_node_id")) : nil
        ...
        self.runAttempt = values.contains("run_attempt") ? Optional.some(try values.decode(Int.self, forKey: "run_attempt")) : nil
        ...
        self.runStartedAt = values.contains("run_started_at") ? Optional.some(try values.decode(Date.self, forKey: "run_started_at")) : nil
        ...
        self.headRepositoryID = values.contains("head_repository_id") ? Optional.some(try values.decode(Int.self, forKey: "head_repository_id")) : nil
    }
