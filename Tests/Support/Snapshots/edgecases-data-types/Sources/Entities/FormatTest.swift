...
public struct FormatTest: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.int32 = values.contains("int32") ? Optional.some(try values.decode(Double.self, forKey: "int32")) : nil
        self.int64 = values.contains("int64") ? Optional.some(try values.decode(Int.self, forKey: "int64")) : nil
