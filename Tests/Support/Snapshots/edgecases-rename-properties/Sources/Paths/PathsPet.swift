...
extension Paths {
    ...
    public struct Pet {
        ...
        public func post(_ body: edgecases_rename_properties.Pet) -> Request<Void, PostError> {
        ...
        public func put(_ body: edgecases_rename_properties.Pet) -> Request<Void, PutError> {
