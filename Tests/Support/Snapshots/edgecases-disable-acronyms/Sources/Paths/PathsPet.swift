...
extension Paths {
    ...
    public struct Pet {
        ...
        public func post(_ body: edgecases_disable_acronyms.Pet) -> Request<Void, PostError> {
        ...
        public func put(_ body: edgecases_disable_acronyms.Pet) -> Request<Void, PutError> {
