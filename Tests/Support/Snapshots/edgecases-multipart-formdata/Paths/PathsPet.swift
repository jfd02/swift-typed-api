...
extension Paths {
    ...
    public struct Pet {
        ...
        public func post(_ body: edgecases_multipart_formdata.Pet) -> Request<Void, PostError> {
        ...
        public func put(_ body: edgecases_multipart_formdata.Pet) -> Request<Void, PutError> {
